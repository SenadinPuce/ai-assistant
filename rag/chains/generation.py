    ...
    [
        (
            ...
            (
                ...
                "You MUST cite the block(s) supporting each claim inline using the same "
                "bracketed numbers, immediately after the sentence that uses it "
                "(e.g. 'Prodaja je rasla [1].'). Every sentence that states a fact drawn "
                "from the context MUST end with at least one bracketed citation — never "
                "omit citations for the sake of brevity, even in a short answer. "
